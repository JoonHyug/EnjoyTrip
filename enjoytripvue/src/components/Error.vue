  ...
  <div>
    <div class="bg-gray-100 h-screen justify-center">
      <center class="mt-24 m-auto">
        ...
        <div class="tracking-widest my-8">
          <span class="text-gray-500 text-6xl block"><span>4 0 4</span></span>
          <span class="text-gray-500 text-2xl"
            >죄송합니다. 존재하지 않는 페이지 입니다.</span
          >
        </div>
      </center>
      <center class="mt-6">
        <a
          class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md cursor-pointer"
          @click="goBack"
          >돌아가기
        </a>
      </center>
